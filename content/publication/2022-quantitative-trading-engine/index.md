...
summary: Trade-that! is an algorithmic trading framework designed to classify market states rather than predict raw price movements. By generating target labels from future data and selecting features via a custom 'label separation power' metric, the engine trains multiple independent classifiers. These are combined into a robust ensemble strategy that optimizes position sizes and adapts to market dynamics, demonstrating significant total returns across diverse market trends.
...
**Patrick Koller**, [Florian Merz](https://www.linkedin.com/in/fmerz/), and [Prof. Hannes Badertscher](https://www.ost.ch/de/person/hannes-badertscher-1677)
